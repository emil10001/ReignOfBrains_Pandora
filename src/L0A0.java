...
public class L0A0 extends Area{
	...
	public BufferedImage build() {
		// TODO Auto-generated method stub
		  ...
		  //g.drawRect((int)level.getArea().helicopter.hitBox.getX(), (int)level.getArea().helicopter.hitBox.getY(), (int)level.getArea().helicopter.hitBox.getWidth(), (int)level.getArea().helicopter.hitBox.getHeight());
