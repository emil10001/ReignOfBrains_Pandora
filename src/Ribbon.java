...
public class Ribbon
{
  ...
  public Ribbon(int w, int h, int moveSz)
  {
    ...
    width = w; //im.getWidth();    // no need to store the height
    if (width < pWidth) 
...
public void moveRight()
  ...
  */
     ...
     //System.out.println("absolutePosition is " + absolutePosition);
  } // end of update()
  ...
  */
  {
    if (xImHead == 0)   // draw im head at (0,0)
      ...
      draw(g, im, 0, pWidth, width-xImHead, width-xImHead+pWidth);  // im tail
      ...
      draw(g, im, width+xImHead, pWidth, 0, pWidth-width-xImHead);  // im head
    }
  } // end of display()
...
public void setPosition(int absolutePosition) {
